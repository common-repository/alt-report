...
<div id="iconlist">
    <?php _e('Choissisez une icone en cliquant dessus','alt_report') ?>
     <div alt="f158" class="dashicons" style="    position: absolute;    right: 0;    top: 0;"><div alt="f158" class="dashicons dashicons-no"><?php _e('Fermer','alt_report') ?></div></div>
    <h4>Admin Menu</h4>
